                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mx-auto max-md:px-2 ">
                        ...
                        <div
                            ...
                            <div className="data w-full max-w-xl">
                                <p className="md:text-lg text-sm font-medium leading-8 text-primary mb-4">{data?.category}</p>
                                <h2 className="font-manrope font-bold text-md md:text-3xl leading-10 text-gray-900 mb-2 capitalize">{data?.title}</h2>
                                <div className="flex flex-col sm:flex-row sm:items-center mb-6">
                                    <h6
                                        className="font-manrope font-semibold md:text-2xl text-sm leading-9 text-gray-900 pr-5 sm:border-r border-gray-200 mr-5">
                                        ${data?.price}</h6>
                                ...
                                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 py-8">
                                    ...
                                    <button 
                                        className="group py-4 px-5 rounded-full bg-indigo-50 text-primary font-semibold text-lg w-full flex items-center justify-center gap-2 transition-all duration-500 hover:bg-indigo-100">
                                        <svg className="stroke-primary " width="22" height="22" viewBox="0 0 22 22" fill="none"
                                            xmlns="http://www.w3.org/2000/svg">
                                            <path
                                ...
                                <div className="flex items-center gap-3">
                                    ...
                                    <button
                                        className="text-center w-full px-5 py-4 rounded-[100px] bg-primary flex items-center justify-center font-semibold text-lg text-white shadow-sm transition-all duration-500 hover:bg-indigo-700 hover:shadow-indigo-400">
                                        Buy
                                    </button>
                                </div>
                            </div>
